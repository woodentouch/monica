###
### Monica — Railway Production Dockerfile
###
### Optimized for Railway deployment:
###   - SQLite (no extra DB service needed)
###   - Cache/session/queue via database driver (no Redis)
###   - Scout search via database driver (no Meilisearch)
###   - Single container (web + cron via busybox)
###
...
# Railway routes traffic to the EXPOSE'd port
EXPOSE 80
